...
<body>
    <header style="text-align: center; background-color: ORANGE; color: white; padding: 1rem 0;">
        <h1>MEOW MOMENTS</h1>
    </header>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="cat1.jpg" style="height: 450px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="meow.jpeg" style="height: 450px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="autumn cat.jpeg" style="height: 450px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="suncat.jpg" style="height: 450px;">
        </div>
    </div>
...
```
# OUTPUT:
![alt text](<Screenshot 2025-12-29 004554.png>)
# RESULT:
